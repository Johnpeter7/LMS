...
<%@ Page Title="" Language="C#" MasterPageFile="../../Master_Template/Trainer/MainDashBoard.Master" AutoEventWireup="true" CodeBehind="TrainerProfile.aspx.cs" Inherits="LMS_Web.UI.Trainer.TrainerProfile"  %>
...
<div class="w3-panel w3-round w3-card  w3-white w3-leftbar w3-border-red ">
    <table >
        ...
        <tr>
            ...
            <td class="LabelDesign2">Department</td>
            <td>
                :<asp:Label ID="lblDepartment" runat="server" Text="" CssClass="LabelDesign"/>
    ...
    <table>
        ...
        <tr>
            ...
            <td>  
                ...
                <br />
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="*Enter E-mail" ControlToValidate="txtEmail" ForeColor="Red"></asp:RequiredFieldValidator>
                <br />
            ...
            <td>
                ...
                <br />
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*Enter Password" ControlToValidate="txtPassword" ForeColor="Red"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td>MobileNumber</td>
            ...
            <td>
                ...
                <asp:DropDownList ID="DropDownList1" runat="server" Visible="true" CssClass="TextBoxDesign">
        ...
        <tr>
            <td>DOB</td>
            <td><asp:TextBox ID="txtDOB" runat="server" CssClass="TextBoxDesign"   ></asp:TextBox>
                <br />
